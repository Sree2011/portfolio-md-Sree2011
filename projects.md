...
- **Highlights**: Built a low‑cost assistive device (< ₹1000) with audio/vibration feedback for visually impaired users.  
...
- **Highlights**: Designed a multipurpose solar charger; assisted in hardware connections and documentation.  
- Presented at **NCKITS 2022** conference.  

---

### Toys for Autistic Kids (IUCEE PBL – Team Project)
- **Duration**: Mar 2020 – Jul 2020  
- **Technologies**: Proteus 8 Professional  
- **Highlights**: Designed a pillow toy for autistic children to provide comfort and engagement.  
...
- **Highlights**: Implemented a tool to calculate bus admittance matrices for power grid studies.  
...
- **Duration**: Nov 2024  
- **Technologies**: Java, Python, MATLAB  
- **Highlights**: Developed a tool to compute line flows and losses in a power grid.  
...
- **Highlights**: Created a library book management system as a personal project.  
...
- **Highlights**: Developed a static website for a government school.  
...
- **Highlights**: Built a basic calculator as a learning project.  
